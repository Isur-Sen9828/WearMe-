  ...
  return (
    <div className="rounded-xl overflow-hidden shadow-lg">
        <div className="relative flexCenter group overflow-hidden transition-all duration-100:">
            <Link to={`product/${id}`} className="h-12 w-12 bg-white rounded-full flexCenter absolute top-1/2 bottom-1/2 !py-2 z-20 scale-20 group-hover:scalw-100 transition-all duration-700">
        ...
        <div className="p-4 overflow-hidden">
            ...
            <div className="text-secondory bold-16 line-through">{old_price}</div>
            </div>
        </div>
    </div>
  )
